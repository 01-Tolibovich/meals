<template>
    <header class="bg-white shadow">
      <div class="max-w-5xl mx-auto flex justify-between items-center h-16">
        <router-link :to="{name: 'home'}" class="inline-flex items-center h-full px-2 hover:bg-purple-100">Home</router-link>
